...
resource "aws_service_discovery_private_dns_namespace" "webserver_service_discovery_ns" {
  name = "webserver-service-discovery"
  vpc  = data.aws_vpc.default.id
}

resource "aws_service_discovery_service" "web_service_1" {
  name = "web-service-1"

  dns_config {
    namespace_id = aws_service_discovery_private_dns_namespace.webserver_service_discovery_ns.id
...
resource "aws_service_discovery_service" "web_service_2" {
  name = "web-service-2"
...
resource "aws_ecs_service" "webserver_1" {
  ...
  service_registries {
    registry_arn = aws_service_discovery_service.web_service_1.arn
  }
...
resource "aws_ecs_service" "webserver_2" {
  ...
  service_registries {
    registry_arn = aws_service_discovery_service.web_service_2.arn
  }
}
